  ...
  return (
    <section id="about" className="space-y-4">
      ...
      <p className="text-sm leading-relaxed text-slate-300">
        I&apos;m a{" "}
        <span className="font-medium text-sky-300">Data Analyst</span> and{" "}
        <span className="font-medium text-sky-300">
          M.Sc. Economics student at the University of Bonn
        </span>
        . Before moving to Germany, I completed a{" "}
        <span className="font-medium">
          Bachelor of Business Administration at Azerbaijan State University of
          Economics
        </span>
        , where I built a strong foundation in business, statistics and
      ...
      <p className="text-sm leading-relaxed text-slate-300">
        ...
        dashboards, improving reporting workflows, and developing machine
        learning models to support risk assessment, customer segmentation and
        forecasting.
      </p>
      ...
      <p className="text-sm leading-relaxed text-slate-300">
        ...
        and statistical analysis, to communicating results in a clear,
